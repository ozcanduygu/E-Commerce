        ...
        <div className="w-full bg-[#FAFAFA] py-20">
            <div className="max-w-6xl mx-auto px-4 flex flex-col">
               <div className="font-montserrat">
                <h3 className="text-[#252B42] font-bold">EDITOR’S PICK</h3>
                <p className="text-[#737373]">Problems trying to resolve the conflict between </p>
               </div>
            </div>
            <div className="w-full flex gap-4 px-4 py-10">
                <div className="flex-1 relative h-[400px] rounded-xl overflow-hidden">
                    ...
                    <button  className="absolute bottom-5 left-5 bg-white px-4 py-2 rounded-md shadow font-semibold">MEN</button>
                </div>
                <div className="flex-1 relative h-[400px] rounded-xl overflow-hidden">
                    <img src={editorspick2} alt="women" className="w-full h-full object-cover" />
                    <button className="absolute bottom-5 left-5 bg-white px-4 py-2 rounded-md shadow font-semibold">WOMEN</button>
                </div>
                <div className="flex-1 flex flex-col gap-4">
                    <div className="relative h-[190px] rounded-xl overflow-hidden">
                        <img src={editorspick3} alt="accesories" className="w-full h-full object-cover"/>
                        <button className="absolute bottom-5 left-5 bg-white px-4 py-2 rounded-md shadow font-semibold">ACCESORIES</button>
                    </div>
                    <div className="relative h-[190px] rounded-xl overflow-hidden">
                        <img src={editorspick4} alt="kids" className="w-full h-full object-cover"/>
                        <button className="absolute bottom-5 left-5 bg-white px-4 py-2 rounded-md shadow font-semibold">KIDS</button>
                    </div>
                </div>
            </div>
        </div>
